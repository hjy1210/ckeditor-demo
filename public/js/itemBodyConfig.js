...
CKEDITOR.editorConfig = function (config) {
  ...
  config.removeButtons = 'Subscript,Superscript,Scayt,Cut,Copy,Paste,PasteText,PasteFromWord,Undo,Redo,Link,Unlink,Anchor,HorizontalRule,Maximize,Strike,About';
